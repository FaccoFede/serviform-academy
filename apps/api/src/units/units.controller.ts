...
export class UnitsController {
  ...
  @Get('course/:courseId') findByCourse(@Param('courseId') courseId: string) { return this.svc.findByCourse(courseId) }
  @Get(':courseSlug/:unitSlug') async findBySlug(@Param('courseSlug') cs: string, @Param('unitSlug') us: string) {
